	...
	<div class="container text-center">
		...
		<form method="post">
             ...
             <div class="input-group input-group-lg">
             	...
             	<input type="email" class="form-control mb-3 ml-2 form-control-lg" placeholder="Correo Electrónico" name="emailContactenos" required>
...
<div class="mapa container-fluid bg-white p-0">
	...
	<div class=" p-4 info"> 
		...
		<p class="pb-4">Email: MohcineLmariouh@gmail.com<br>
		Tel: 643 446 409 </p>
