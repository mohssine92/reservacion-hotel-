...
class ModeloBanner{
	...
	static public function mdlMostrarBanner($tabla, $item, $valor){
		...
		if($item != null && $valor != null){   /* mostrar solo una imagen de banner */
		...
		}else{      /* sino listame por defecto toda imagenes de banner  */

			$stmt = Conexion::conectar()->prepare("SELECT * FROM $tabla ORDER BY id DESC");  /* Mostrar primero el ultimo id que se hayya creado */
