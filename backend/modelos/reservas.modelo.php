...
class ModeloReservas{
	...
	static public function mdlMostrarReservas($tabla1, $tabla2, $item, $valor){  
		...
		if($item != null && $valor != null){
			...
			return $stmt -> fetchAll();  /* => fechAll en este caso me va traer todas reservas de un if habitacion   */
			                            /* => si por ej solo iba isar para returnar solo un registro por id reserva solo usaba fech , pero como he indicado por eso uso fechall  */
