...
$("input[name='subirImgPeqRecorrido'], input[name='editarImgPeqRecorridoActual']").change(function(){
  ...
  /*=============================================
    ...
    if(imagen["type"] != "image/jpeg" && imagen["type"] != "image/png"){
      ...
      $("input[name='subirImgPeqRecorrido'], input[name='editarImgPeqRecorridoActual']").val("");
...
$("input[name='subirImgGrandeRecorrido'], input[name='editarImgGrandeRecorridoActual']").change(function(){
  ...
  /*=============================================
    ...
    if(imagen["type"] != "image/jpeg" && imagen["type"] != "image/png"){
      ...
      $("input[name='subirImgGrandeRecorrido'], input[name='editarImgGrandeRecorridoActual']").val("");
