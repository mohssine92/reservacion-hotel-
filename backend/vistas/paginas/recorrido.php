...
<div class="modal" data-backdrop="static" id="editarRecorrido">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <input type="hidden" class="form-control" name="idRecorrido">   <!-- id -->
        ...
        <div class="input-group mb-3">
          ...
          <textarea class="form-control" maxlength="220" name="editarDescripcionRecorrido" required></textarea>   <!-- desccripcion a subir -->
        ...
        <div class="form-group">
          ...
          <div class="form-group my-2">
            ...
            <div class="btn btn-default btn-file">
                ...
                <input type="file" name="editarImgPeqRecorridoActual">   <!-- File a subir -->

                <input type="hidden" name="imgPeqRecorridoActual">  <!-- image pequeña actual -->
        ...
        <div class="form-group">
          ...
          <div class="form-group my-2">
            ...
            <div class="btn btn-default btn-file">
                ...
                <input type="file" name="editarImgGrandeRecorridoActual">   <!-- File -->

                <input type="hidden" name="imgGrandeRecorridoActual">   <!-- image grande actual -->
