        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            ...
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Reservas</li> <!-- se trata de pagima anliticas  -->
  ...
  <div class="modal-content">
   ...
   <!-- Modal Header -->
      ...
      <div class="bg-white p-4 calendarioReservas">
        ...
        <div class="float-right pb-3">
          ...
          <ul style="list-style:none">
            ...
            <li>
              <i class="fas fa-square-full" style="color:#0F15DF"></i> Dia actual
            </li>
          </ul>
    ...
    <div class="modal-footer d-flex justify-content-between">
      ...
      <div>
        <button type="button" class="btn btn-primary guardarNuevaReserva" fechaIngreso fechaSalida idReserva>Guardar</button>  <!-- o origen empiezan vacillas asi si no selecciona lanza error -->
      </div>
