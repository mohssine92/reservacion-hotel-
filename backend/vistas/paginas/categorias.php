...
<div class="modal" id="crearCategoria" data-backdrop="static">
    ...
    <form method="post" enctype="multipart/form-data">
      ...
      <div class="modal-body">
        ...
        <div class="input-group mb-3">
          ...
          <input type="text" class="form-control" name="rutaCategoria" placeholder="Ingresa la ruta de la categoría" required> <!-- como la estamos usando en rutas amigables vamos manipulanto escritura de manera automatica -->

        </div>

         <div class="colorPicker input-group mb-3 colorpicker-component">        

           <div class="input-group-append input-group-text">  	<!-- Bootstrap Color Picker -->
             <span class="input-group-addon"><i style="background-color:rgb(166, 85, 85); "></i></span> <!-- usamos un plugin nos va permitir seleccionar colores  --> <!-- me va arrojar codigo ALFA NUMERICO  que se va guardar en base de datos  -->
          </div> 
        ...
        <div class="form-group">
          ...
          <div class="form-group my-2">
            ...
            <img class="previsualizarImgCategoria img-fluid py-2">  <!-- js se encarga de mostrar imagen temporalmentente con respecto a sus dimensiones  -->
          ...
          <textarea class="p-3" name="descripcionCategoria" style="width: 100%" maxlength="30"></textarea> <!-- lo hacemos con limites de caracteres   --> <!-- para que no nos dañe la estetica de front end  -->

        </div>

        <hr class="pb-2">

        <p>Características de la Categoría:</p>  <!-- aqui para poder seleccionar y deseleccionar vamos a atrabajar con un plugin -->   <!-- iCheck github --> 

        <div class="form-check">
          <label class="form-check-label">
          <input class="checkbox" type="checkbox" class="ml-3" value="Cama 2 x 2,fas fa-bed">  <!-- input , trae valor texto separado por ,  -->
          <span class="badge badge-secondary"><i class="fas fa-bed"></i> Cama 2 x 2 </span>  <!-- badge -->
          </label>
        </div>
        ...
        <input type="hidden" name="caracteristicasCategoria"><!--todas esas caracteristicas que han sido seleccionadas quedan guardadas en el value de ese input quedan gardados en el formato string json : es lo que voy a subir a base de datos  -->     
    ...
    <div class="modal-content">
      ...
      <form method="post" enctype="multipart/form-data">
        ...
        <div class="modal-body">
          ...
          <input type="hidden" class="form-control" name="idCategoria">  <!-- input occulto  -->
          ...
          <div class="input-group mb-3">
            ...
            <input type="text" class="form-control" name="editarRutaCategoria" required>    <!-- entra de id de categoria  -->
           ...
           <div class="colorPicker input-group mb-3 colorpicker-component">        
            ...
            <input type="text" class="form-control" style="font-family:Source Sans Pro, Font Awesome\ 5 Free" name="editarColorCategoria" required>  <!-- entrada del color  -->
          ...
          <div class="input-group mb-4">
            ...
            <input type="text" class="form-control" name="editarTipoCategoria" required readonly>    <!-- input bloqueado no se puede editar solo ver readonly   -->  <!-- ver video hay un proceso complejo en php -->
          ...
          <div class="form-group">
            ...
            <div class="form-group my-2">   <!-- proceso adjuntar imagen -->
          ...
          <input type="hidden" name="editarCaracteristicasCategoria">        <!-- aqui se captan los objetos de check -->  
          ...
          <div class="input-group mb-3">
           ...
           <div class="input-group mb-3">
            ...
            <div class="input-group-append input-group-text">   <!-- inpts de los precios -->
              <span class="fas fa-dollar-sign"></span>
            </div>
