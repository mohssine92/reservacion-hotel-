  ...
  <section class="content">
    ...
    <div class="card card-primary card-outline">
       ...
       <div class="card-header pl-2 pl-sm-3">
        ...
        <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#crearRestaurante">Crear nuevo plato de restaurante</button>
...
<div class="modal" data-backdrop="static" id="editarRestaurante">
